...
@dkmassive/proto/0.1.1 darwin-x64 node-v12.16.1
$ proto --help [COMMAND]
USAGE
  $ proto COMMAND
...
...
_See code: [src/commands/component.js](https://github.com/dk-massive/proto/blob/v0.1.1/src/commands/component.js)_
...
_See code: [src/commands/hello.js](https://github.com/dk-massive/proto/blob/v0.1.1/src/commands/hello.js)_
